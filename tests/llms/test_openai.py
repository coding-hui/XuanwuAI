...
from xuanwuai.llms.base import ChatMessage
    ...
    *args: Any, **kwargs: Any
    ...
    responses = [
        Completion(
            ...
            model="text-davinci-003",
            choices=[
                CompletionChoice(logprobs=None, text="1", finish_reason="stop", index=0)
            ],
        ),
        Completion(
            id="cmpl-uqkvlQyYK7bGYrRHQ0eXlWi7",
            ...
            model="text-davinci-003",
            choices=[
                CompletionChoice(logprobs=None, text="2", finish_reason="stop", index=0)
            ],
        ),
    ]
    yield from responses
...
@patch("xuanwuai.llms.openai.SyncOpenAI")
...
@pytest.mark.asyncio()
@patch("xuanwuai.llms.openai.AsyncOpenAI")
